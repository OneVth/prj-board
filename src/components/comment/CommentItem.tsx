    ...
    <div className="border-b border-gray-800 py-4">
      <div className="flex items-start gap-3">
        ...
        <Link
          ...
          className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-xs font-bold flex-shrink-0 hover:opacity-80 transition-opacity"
        >
